...
# Harjoitus 2:
# Suunnittele ja kirjoita algoritmi, joka luo uuden sanan alkuperäisen perusteella
# siten, että alkuperäisestä sanasta otetaan uuteen sanaan joka toinen kirjain.
